...
export default function ExperienceCard() {
    ...
    md:w-[600px] xl:w-[900px] snap-center dark:bg-dark bg-slate-300 p-10 hover:opacity-100 opacity-40 
    cursor-pointer transition-opacity duration-200 overflow-hidden text-black dark:text-white "
        >
            <motion.img
                ...
                viewport={{ once: true }}
                className="w-32 h-32 tablet:w-fit tablet:h-1/2 laptop:h-64  object-cover object-center rounded-xl shadow-xl"
                src={Works4}
                alt=""
            />
