...
export default function ExperienceCard() {
    return (
        <article
            className="flex h-screen flex-col unique-border items-center space-y-7 flex-shrink-0 w-[500px] justify-center
    md:w-[600px] xl:w-[900px] snap-center bg-slate-300 dark:bg-dark p-10 hover:opacity-100 opacity-40 
    cursor-pointer transition-opacity duration-200 overflow-hidden text-black dark:text-white "
        >
            <motion.img
                ...
                viewport={{ once: true }}
                className="w-32 h-32 tablet:w-fit tablet:h-fit object-cover object-center shadow-xl tablet:mt-24"
                src={works1}
                alt=""
            />
